...
class HataySandıkIçiFanTestGame              //I used AI to compile my idea into code. I decided whats will be questions and possibilities but ai helped me with writing.
{
    ...
    {
        Console.WriteLine("Heluu! Welcome to the Hatay Sandık Ici Fan test game. First of alll...");
        Console.Write("Please give me your name: ");
        string playerName = Console.ReadLine();

        Console.WriteLine($"\nHalo (with german sound) {playerName}! Now I will test if you are a true fan of Hatay Sandik Ici :sunglasses: or not!");
        ...
        do
        {
            Console.WriteLine("1. Who is Hatay Sandik Ici?");
        ...
        do
        {
            Console.WriteLine("\n2. What is the name of the owner of Hatay Sandik Ici channel?");
            Console.WriteLine("A) Eser Yenenler");
            Console.WriteLine("B) Firat Sobutay");
        ...
        do
        {
            Console.WriteLine("\n3. What type of videos does Hatay Sandik Ici create?");
        ...
        do
        {
            Console.WriteLine("\n4. Does Hatay Sandik Ici have any children?");
        ...
        else if (answer4 == "B") 
        {
            do
            {
                Console.WriteLine("\nBB) Are you sure you are a Hatay Sandik Ici fan?");
        ...
        if (answer1 == "A")
            Console.WriteLine("Great! You know that Hatay Sandik Ici is a YouTuber.");
        else
            Console.WriteLine("Oops! Hatay Sandik Ici is a YouTuber, not what you guessed!");
        ...
        if (answer3 == "B")
            Console.WriteLine("Yummy! You know Hatay Sandik Ici makes food-related videos.");
        else
        ...
        {
            Console.WriteLine("Not true! Hatay Sandik Ici does have a daughter named Bade.");
            if (answerBB == "A")
        ...
        Console.WriteLine("\nYou always be a fan of Hatay Sandik Ici. Everybody will one day. DW. Thanks for playing See yA");
    }
}
